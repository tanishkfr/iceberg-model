...
export const NODES: IcebergNode[] = [
  // ── Events — what was visible ─────────────────────────────────────────────
  {
    id: 'e1',
    layer: 'events',
    title: 'Settlements cleared near summit routes',
    description:
      'Slums and temporary shelters along key routes and near venues were demolished ahead of the summit.',
    summary: 'Demolition along visitor corridors',
    bullets: [
      'Multiple shantytowns and night shelters were razed.',
      'Some cleared sites were converted into parks or open ground.',
      'Clearances concentrated on corridors visitors would travel.',
    ],
    connectsTo: ['p1', 'p6'],
    pos: { x: 800, y: 588 },
  },
  {
    id: 'e2',
    layer: 'events',
    title: 'Informal settlements screened from view',
    description:
      'Green sheets, walls and barricades were installed to hide settlements that were not removed.',
    summary: 'Barriers used instead of removal',
    bullets: [
      'Barriers were placed along routes rather than around need.',
      'Concealment was used where demolition was not possible.',
    ],
    connectsTo: ['p2', 'p4'],
    pos: { x: 722, y: 648 },
  },
  {
    id: 'e3',
    layer: 'events',
    title: 'Shops covered or moved from view',
    description:
      'Vendors were asked to cover their shopfronts or relocate away from zones visitors would pass.',
    summary: 'Trade hidden rather than stopped',
    bullets: [
      'Instructions targeted appearance, not trading activity.',
      'Relocation moved livelihoods off the main corridors.',
    ],
    connectsTo: ['p2', 'p3'],
    pos: { x: 884, y: 652 },
  },
  {
    id: 'e4',
    layer: 'events',
    title: 'High-visibility areas upgraded',
    description:
      'Roads, parks, fountains, statues and lighting were improved in areas expected to be seen.',
    summary: 'Spending followed the sightlines',
    bullets: [
      'Spending followed sightlines rather than need.',
      'Upgrades clustered around venues and arrival routes.',
    ],
    connectsTo: ['p1', 'p2'],
    pos: { x: 664, y: 712 },
  },
  {
    id: 'e5',
    layer: 'events',
    title: 'Vendors, beggars and animals removed',
    description:
      'Street vendors, beggars and stray animals were cleared from areas expected to be seen by visitors and media.',
    summary: 'People cleared as untidiness',
    bullets: [
      'Hawkers were cleared from roads and footpaths.',
      'The removals were described as beautification.',
    ],
    connectsTo: ['p3', 'p6'],
    pos: { x: 812, y: 706 },
  },
  {
    id: 'e6',
    layer: 'events',
    title: 'Displaced residents left without housing',
    description:
      'Many of those displaced were not provided adequate alternative accommodation.',
    summary: 'Rehousing largely absent',
    bullets: [
      'Rehabilitation was inconsistent where it existed at all.',
      'Notice periods were short or absent.',
    ],
    connectsTo: ['p5', 'p6'],
    pos: { x: 944, y: 716 },
  },
  {
    id: 'e7',
    layer: 'events',
    title: 'Filming and documentation restricted',
    description:
      'Reports emerged of limited on-ground documentation and restricted filming in certain areas.',
    summary: 'Limits on independent recording',
    bullets: [
      'Access limits reduced independent recording.',
      'Restrictions applied to specific locations.',
    ],
    connectsTo: ['p8'],
    pos: { x: 628, y: 792 },
  },
  {
    id: 'e8',
    layer: 'events',
    title: 'Concealment accepted to avoid eviction',
    description:
      'Residents accepted screening measures rather than risk eviction or further displacement.',
    summary: 'Consent under threat of loss',
    bullets: [
      'Consent was shaped by the alternative on offer.',
      'Cooperation was read publicly as agreement.',
    ],
    connectsTo: ['p3', 'p6'],
    pos: { x: 790, y: 788 },
  },
  {
    id: 'e9',
    layer: 'events',
    title: 'Coverage favoured visible improvement',
    description:
      'Media attention largely tracked the visible upgrades, with limited sustained focus on displacement.',
    summary: 'Upgrades reported, displacement not',
    bullets: [
      'Improvement was easy to photograph; displacement was not.',
      'Critical reporting appeared briefly and faded.',
    ],
    connectsTo: ['p8', 'p9'],
    pos: { x: 966, y: 796 },
  },
